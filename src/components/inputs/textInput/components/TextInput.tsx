  ...
  return (
    <div
      ...
      style={{
        ...
        padding: '0px 7px', // Padding for better aesthetics
    ...
    >
      ...
      <textarea
        ...
        rows={1} // Ensure the textarea starts with one line
        style={{
          ...
          padding: '1px 5px 1px 20px', // Adjusted padding: top, right, bottom, left
